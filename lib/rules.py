...
def run_script(args):
  ...
  parser.add_argument('--create-match', action='store_true', required=False, dest="create_match", help='Create the SQLi & XSS match conditions for use in various rules')
  ...
  parser.add_argument('--create-rule', action='store_true', required=False, dest="create_rule", help='Create the SQLi & XSS rule for instances that can be mapped to an AWS WAF WACL. Used in conjunction with -l/--list')
